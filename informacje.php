	...
	<div id="page-content-wrapper">
		<div class="row" id="witaj-zew">
				<div class="container-fluid col-md-8" id="witaj">
					...
					<h1>Twoja przesylka: 
          <?php
										$data = $connect->query("SELECT register_user.user_name, register_user.user_surname, register_user.user_email from register_user where 	register_user.register_user_id = '".$_SESSION['user_id']."';")->fetchAll();
										 foreach ($data as $row) {
										     echo $row['user_name']."\n";
