                ...
                <div class="row">
                    ...
                    text-align: center;" id="options">
                        <form>
                            ...
                            <button type="button" onclick="przekaz()" class="btn btn-secondary btn-lg" style="margin-bottom: 1em">Wyszukaj</button>
                            <button type="button" onclick="statystyki()" class="btn btn-secondary btn-lg" style="margin-bottom: 1em">Statystyki</button>
                            <span id="myText"></span>
                        </form>
                    </div>
                </div>
...
<script>
    ...
    function przekaz() {
        ...
        var link = 'allpaczki.php?'.concat('id_paczkomatu=',paczkomat,'&register_user_id=',user,'&id_kuriera=',kurier,'&rozmiar=',rozmiar,'&status=',status,'&sort=',sort,'&order=',order);
    ...
    function statystyki() {
        ...
        var link = 'statystyki.php?'.concat('id_paczkomatu=',paczkomat,'&register_user_id=',user,'&id_kuriera=',kurier,'&rozmiar=',rozmiar,'&status=',status);
        location.href = link;
    }
